...
func outputWithZodiacSign(p Person) {
	...
	// https://www.yourzodiacsign.com/calendar/2025/
	if p.Month == 1 && p.Day < 19 {
		zodiacSign = Capricon
	} else if p.Month == 2 && p.Day < 18 {
		zodiacSign = Aquarius
	} else if p.Month == 3 && p.Day < 20 {
		zodiacSign = Pisces
	} else if p.Month == 4 && p.Day < 19 {
		zodiacSign = Aries
	} else if p.Month == 5 && p.Day < 20 {
		zodiacSign = Taurus
	} else if p.Month == 6 && p.Day < 21 {
		zodiacSign = Gemini
	} else if p.Month == 7 && p.Day < 22 {
		zodiacSign = Cancer
	} else if p.Month == 8 && p.Day < 22 {
		zodiacSign = Leo
	} else if p.Month == 9 && p.Day < 22 {
		zodiacSign = Virgo
	} else if p.Month == 10 && p.Day < 23 {
		zodiacSign = Libra
	} else if p.Month == 11 && p.Day < 22 {
		zodiacSign = Scorpio
	} else if p.Month == 12 && p.Day < 21 {
